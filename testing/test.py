...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_path', type=str, default='/app/betty/angle-mxnet/angle/72/fanet8ss_inference/size128_angle10_try0/model.params')
    parser.add_argument('--model', type=str, default='fanet8ss_inference')
    parser.add_argument('--landmark_type', type=int, default=72) #5 or 72 or 83
    ...
    for idx, im_path in enumerate(os.listdir(arg_dict['images_folder'])):
        ...
        if angles is not None:
            ...
            cv2.putText(img, str(angles[1]*180 - 90), (50,50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 1)
        else:
