...
def main():
    ...
    parser.add_argument('--input_paths', type=str, nargs='+',
                        default='/app/betty/angle-mxnet/angle/dataset/out.txt')
    parser.add_argument('--working_root', type=str, default='/app/betty/angle-mxnet/angle')
    parser.add_argument('--batch_size', type=int, default=512, help="Batch size for training")
    parser.add_argument('--landmark_type', type=int, default=72, help="The number of points. 5, 72, 83")
    ...
    parser.add_argument('--gpu_device', type=str, default='0,1', help="GPU index")
    parser.add_argument('--img_format', type=str, default='RGB', help="The color format for training.")
    parser.add_argument('--train_angle', type=bool, default=True, help="angle loss.")
